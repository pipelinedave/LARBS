...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/pipelinedave/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/pipelinedave/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "yadig" 10 60
